    ...
    <footer className="bg-brand-900 text-brand-100">
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-4 py-10 sm:grid-cols-4">
        <div className="col-span-2 sm:col-span-1">
          <div className="mb-2 text-base font-medium text-white">SEAPEDIA</div>
          <p className="text-sm leading-relaxed text-brand-100/80">
            A multi-store marketplace for buyers, sellers, and drivers.
          </p>
        </div>
        ...
        <div>
          <div className="mb-3 text-sm font-medium text-white">Follow us</div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-brand-100/70">
